        ...
        <nav class="navbar sticky-top navbar-expand-md navbar-light bg-white shadow-sm ">
            <div class="container offset-2 col-8">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto col-3">
                        ...
                        @else
                            <div class="row">
                                <div class="col-6 offset-3 d-flex align-items-center">
                                    <a class="navbar-brand d-flex " href="{{ url('/') }}">
                                        <img src="/svg/home.svg" alt="home svg" style="height: 30px;">
                                    </a>
                                    <a class="navbar-brand d-flex" href="{{ url('/explore/people') }}">
                                        <img src="/svg/explore1.svg" alt="home svg" style="height: 25px;">
                                    </a>
